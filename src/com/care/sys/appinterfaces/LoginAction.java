...
public class LoginAction extends BaseAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
		   ...
		   user_name = object.getString("user_name");
			String user_password = object.getString("user_password");
			 belongProject = object.has("belong_project")?object.getString("belong_project"):"0";
		...
		insertVisitReason(href,"12",reason,user_id,0,start,new Date(),json.toString().getBytes("utf-8").length);
