package com.care.sys.sysregisterinfo.domain;
...
public class UserInfo extends PublicVoBean implements Serializable {
	...
	private static final long serialVersionUID = 122369715628322516L;
	...
	private String apply_status; //0表示新申请，1表示批准，2表示未批准
