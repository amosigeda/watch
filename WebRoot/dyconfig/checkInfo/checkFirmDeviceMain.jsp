...
function finds(){
	...
	frmGo.action="doCheckInfo.do?method=queryFirmDevice";
	frmGo.submit();
}
function c(){
...
function downloadZip(path){
	var obj = path.split(",");
	frmGo.action="doCheckInfo.do?method=downloadZip&download="+obj[0]+"&belong_project="+obj[1];
   	frmGo.submit();
}
function del(id){
		if(confirm("确定删除吗?"))
				...
				<logic:iterate id="element" name="pageList">
					<tr class="tr_5" onmouseover='this.className="tr_4"' onmouseout='this.className="tr_5"' >						
						...
						<td>
							...
							<a href="#" onclick="downloadZip('<bean:write name="element" property="download_path" />,<bean:write name="element" property="belong_project" />')" style="color:#0000FF" >【下载】</a>
