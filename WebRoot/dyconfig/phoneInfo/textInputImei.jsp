...
<form name="frmGo" method="post" action="doPhoneInfo.do?method=textInput" encType="multipart/form-data" onsubmit="return onAdd()">
  	...
  	<input name="file1" type="file"/><font color="red">*（多个IMEI换行）</font>
  	<br/><br/>
