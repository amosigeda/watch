				...
				<logic:iterate id="element" name="pageList">
					...
					<%-- 	<a href=# onclick="updateStatus('<bean:write name="element" property="id" />')" style="color:#0000FF" >
						...
						<logic:equal name="element" property="status" value="0">			
   							<a href="#" onclick="updateStatus(<bean:write name='element' property='id'/>,1)" style="color:#0000FF">【显示】</a>		
   						</logic:equal>			
   							
   						<logic:equal name="element" property="status" value="1">			
   							<a href="#" style="color:red"  onclick="updateStatus(<bean:write name='element' property='id'/>,0)">【隐藏】</a>		
   						</logic:equal>	
