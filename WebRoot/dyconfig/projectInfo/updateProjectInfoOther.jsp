 ...
 <!--      onchange="selectProject(this.value)"> -->
  ...
  <tr class="tr_11">
   ...
   <tr class="tr_11">
    ...
    <td align="left" >
      <input type="text"  size="50" name="adDetail" id="adDetail" value=<%=projectInfo.getAt("adDetail")%>
       >
    </td>
    <td></td>
  </tr>
   <tr class="tr_11">
    <td width="7%" align="left">&nbsp;&nbsp;图片</td>
     <td>
    	<%-- <img src="<%=request.getContextPath()%>/photo/1540448476358.jpg"></img> --%>
    	 <img src="<%=projectInfo.getAt("channel_id")%>" style="width:400px;height:200px;"></img> 
							<!--  <img src="http://localhost:8080/ads/photo/1540448476358.jpg"    style="width:400px;height:200px;"/> -->
						</td>
    <td align="left" >
