...
<form name="frmGo" method="post" action="doProjectInfo.do?method=updateProjectInfo" onsubmit="return onUpdate()">
...
<table width="100%" border="0"cellpadding="0" cellspacing="1"  class="tbl_11">
  ...
  <tr  class="tr_11">
    ...
    <td  align="left">&nbsp;&nbsp;&nbsp;<input type="button" name="ok" accesskey="y" tabindex="y"  value="确 定" class="but_1" onclick="onUpdate()">
      ...
      <input type="button" name="back" accesskey="b" tabindex="b" value="返 回" class="but_1" onclick="location='doProjectInfo.do?method=queryProjectInfo'">
