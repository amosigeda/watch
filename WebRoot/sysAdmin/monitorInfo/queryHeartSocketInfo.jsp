...
<body>
	...
	<form name="frmGo" method="post"
		action="doMonitorInfo.do?method=queryHeartSocketInfo">
		...
		<table width="100%" class="table">
			<tr>
				<th colspan="13" nowrap="nowrap" align="left">心跳信息</th>
			</tr>
			<tr class="title_3">
				<td colspan="13">时间范围 <input name="startTime" type="text"
					...
					size="14"> 
						端口<input id="jieKou" name="duanKou" type="text"
					class="txt_1"
			...
			<logic:iterate id="element" name="pageList">
				...
				<%-- 	<logic:equal name="element" property="b_g" value="12">吉久通</logic:equal> --%>
					...
					<td><bean:write name="element" property="dianL" /></td>
