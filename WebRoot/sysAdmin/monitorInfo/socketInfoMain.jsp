...
<body>
	...
	<form name="frmGo" method="post"
		action="doMonitorInfo.do?method=querySocketInfo">
		...
		<table width="100%" class="table">
			...
			<tr class="title_3">
				<td colspan="13">时间范围 <input name="startTime" type="text"
					...
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" size="15"
					class="Wdate" readonly> smdid<input id="serieNo"
					name="serieNo" type="text" class="txt_1"
					value="<%CommUtils.printReqByAtt(request,response,"serieNo");%>"
					size="8"> 接口<input id="jieKou" name="jieKou" type="text"
					class="txt_1"
			...
			<logic:iterate id="element" name="pageList">
				<tr class="tr_5" onmouseover='this.className="tr_4"'
					...
					<a style="color: #0000FF"
								href="../../dyconfig/deviceActiveInfo/doDeviceActiveInfo.do?method=queryDeviceActiveInfoOne&deviceImei=<bean:write name="element" property="user_id" />">
